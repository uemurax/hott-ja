...
\begin{myBlock}{000J}{myNotation}
  ...
  \item \myInlineMath{\myAbs{x_{1}}{\myDots \myAbs{x_{n}}{b}}}は
    \myInlineMath{\myAbs{x_{1} \myDots x_{n}}{b}}と略記することがある。
  \item \myInlineMath{f\myAppParen{a_{1}}\myDots\myAppParen{a_{n}}}は
    \myInlineMath{f\myAppParen{a_{1}, \myDots, a_{n}}}と略記することがある。
