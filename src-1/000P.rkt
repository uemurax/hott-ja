...
(define part:000P
  @rule[
    ...
    @paragraph{
      ...
      @unordered-list[
        @list-item{要素@($ (("a" . _ ."2") . elem-of . "A"))に対し、@emph{同一視型(identity type)}@($ ((("a" . _ . "1") . id-type . ("a" . _ . "2")) . elem-of . @universe{i}))を構成できる。@($ (("a" . _ . "1") . id-type . ("a" . _ . "2")))の要素を@($ ("a" . _ . "1"))と@($ ("a" . _ . "2"))の@emph{同一視(identification)}と呼ぶ。}
