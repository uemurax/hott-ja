...
@definition[
  ...
  @paragraph{
    ...
    @unordered-list[
      ...
      @list-item{@(math (span/cocone-over:in-leg-l . elem-of . (d-fun-type (implicit (x . elem-of . (A . record-field . span:center))) (d-fun-type (y . elem-of . ((B . record-field . span-over:center) . $ . x)) ((span/cocone-over:in-left . $ . ((B . record-field . span-over:leg-l) . $ . y)) . (id-type-over span/cocone-over:vertex ((C . record-field . span/cocone:in-leg-l) . $ . x)) . (span/cocone-over:in-center . $ . y))))))}
      @list-item{@(math (span/cocone-over:in-leg-r . elem-of . (d-fun-type (implicit (x . elem-of . (A . record-field . span:center))) (d-fun-type (y . elem-of . ((B . record-field . span-over:center) . $ . x)) ((span/cocone-over:in-right . $ . ((B . record-field . span-over:leg-r) . $ . y)) . (id-type-over span/cocone-over:vertex ((C . record-field . span/cocone:in-leg-r) . $ . x)) . (span/cocone-over:in-center . $ . y))))))}
    ]
