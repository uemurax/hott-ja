...
\HTMLPageTop{}
\HTMLPageBottom{}
\renewcommand{\linkpreviousname}{前}
\renewcommand{\linknextname}{次}
\renewcommand{\linkhomename}{ホーム}
\renewcommand{\sidetocname}{
  \begin{BlockClass}{my-sidetoc-nav}
    \begin{BlockClass}{my-sidetoc-prev}
      \LinkPrevious
    \end{BlockClass}
    \begin{BlockClass}{my-sidetoc-next}
      \LinkNext
    \end{BlockClass}
  \end{BlockClass}
}
...
\subfile{node-007H-contributors}
...
\subfile{node-007E-bibliography}
\subfile{node-007F-index}
\subfile{node-007G-node-index}
