...
\begin{myBlock}{004W}{myExample}
  ...
  \myRef{0049}より同値\myInlineMath{(A \myIdType B) \myEquiv
  ...
  \end{itemize}
  この型の要素はいわゆる\myNewTerm[ぐんどうけい]{群同型}(group isomorphism)である。
  \myInlineMath{\myGroupAxiom{G}}の定義で\myInlineMath{\myIsSet{G\myRecordField\myGroupCarrier}}
  を落とすと、\myInlineMath{\myGroup{i}}の同一視の特徴付けは
