...
\myInlineMath{\myCatId{x}}をどのように見ているかを区別するために別の表記を導入する。

\subfile{node-006U}

\emph{米田の補題}(\myRef{006T})は\myInlineMath{\myYoneda{C}{x}}は
\myInlineMath{\myYonedaGen{x} \myElemOf \myYoneda{C}{x}{x}}で
